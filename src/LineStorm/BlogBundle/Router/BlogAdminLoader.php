...
class BlogAdminLoader extends Loader implements LoaderInterface
{
    ...
    {
        return 'linestorm_blog_admin' === $type;
    }
    ...
    private function makeHomepageRoute()
    {
        ...
        $pattern = '/dashboard';
        $defaults = array(
            '_controller' => 'LineStormBlogBundle:Admin:index',
        );
        $requirements = array();
        $route = new Route($pattern, $defaults, $requirements, array(),'', array(), array('GET'));

        // add the new route to the route collection:
        $routeName = 'linestorm_blog_admin_index';
