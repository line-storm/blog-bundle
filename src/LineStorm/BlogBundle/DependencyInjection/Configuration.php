            ...
            ->children()
                ...
                ->arrayNode('entity_classes')
                    ...
                    ->children()
                        ...
                        ->scalarNode('post_article')->defaultValue('LineStorm\BlogBundle\Entity\Post')->end()
                        ->scalarNode('post_gallery')->defaultValue('LineStorm\BlogBundle\Entity\Post')->end()
                        ->scalarNode('post_gallery_picture')->defaultValue('LineStorm\BlogBundle\Entity\Post')->end()
